...
QEMU_COMMON_FLAGS=-m 256 -cpu core2duo -smp 1 -device virtio-serial,id=nxtoolsBus0 -device virtserialport,chardev=nxtoolsChardev0,name=kata,id=nxtoolsGuest0 -chardev socket,path=/tmp/GOV,server,nowait,id=nxtoolsChardev0
